...
public class AccGroupPostCommentServiceTests {
    ...
    public void testModifyGroupPostComment() {
        AccGroupPostCommentVO comment = new AccGroupPostCommentVO(11, LocalDateTime.now().toString(), "변경된 댓글입니다.", 2, 1, 2);
    ...
    public void testDeleteGroupPostComment() {
        AccGroupPostCommentVO comment = new AccGroupPostCommentVO(11, "2024-09-03 09:59:18", "변경된 댓글입니다.", 2, 1, 2);
