...
public class StoreController {
    ...
    public ResponseEntity<ResponseMessageGeneric<List<StoreDTO>>> searchStore(
            @RequestParam(name = "is-good") YesOrNo isGood,
            @RequestParam(name = "is-many-review") Boolean isManyReview) {
        StoreSearchCriteria criteria = new StoreSearchCriteria(isGood, isManyReview);
    ...
    public ResponseEntity<ResponseMessage> getStoreCodeByLatLng(
        ...
        Integer storeCode = storeService.findStoreCodeByLatLng(criteria);
        Map<String, Object> resultMap = new HashMap<>();
