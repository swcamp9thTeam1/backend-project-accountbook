...
class RegularExpenseEntityServiceTests {
    ...
    public void testRegistRegularExpense() {
        RegularExpense newExpense = new RegularExpense(10, "정기지출테스트", 50000, 1, 1, 1);

        regularExpenseService.registRegularExpense(newExpense);
...
//        Assertions.assertTrue(result == 1);
    ...
    public void testModifyRegularExpense() {
        regularExpenseService.modifyRegularExpense(new RegularExpense(17, 7, "정기지출77", 70000, 7, 3, 3));
...
//        Assertions.assertTrue(result == 1);
    ...
    public void testDeleteRegularExpense() {
        regularExpenseService.deleteRegularExpense(new RegularExpense(16, 1, "예금", 50000, 1, 1, 1));
